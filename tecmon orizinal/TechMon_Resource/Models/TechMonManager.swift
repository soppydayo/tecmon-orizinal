...
class TechMonManager {
    ...
    init() {
        ...
        // キャラクターの設定
        player = Character(name: "勇者", imageName: "yusya.png", attackPoint: 40, maxHP: 200, maxTP: 100, maxMP: 20)
        enemy = Character(name: "ドラゴン", imageName: "image-4", attackPoint: 20, maxHP: 400, maxTP: 0, maxMP: 35)
    }
